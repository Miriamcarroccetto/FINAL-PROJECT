...
import {
  GiForestCamp, GiMeditation, GiPaintBrush, GiMusicalNotes, GiCityCar,} from "react-icons/gi";
      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            <Nav.Link as={Link} to='/home' > <IoMdHome className='navbar-icon' /> </Nav.Link>
            ...
            {isAuthenticated() && (
              isAdmin() ? (
                <Nav.Link as={Link} to="/admin/experiences/my-experiences">
                  <IoMdMap className='navbar-icon' /> Le tue esperienze
                </Nav.Link>
              ) : (
